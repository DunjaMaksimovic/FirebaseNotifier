...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FirebaseNotifier",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16FirebaseNotifier11AppDelegate")
...
@interface AppDelegate (SWIFT_EXTENSION(FirebaseNotifier)) <UNUserNotificationCenterDelegate>
...
SWIFT_CLASS("_TtC16FirebaseNotifier18HomeViewController")
...
@interface HomeViewController (SWIFT_EXTENSION(FirebaseNotifier)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC16FirebaseNotifier13SceneDelegate")
...
SWIFT_CLASS("_TtC16FirebaseNotifier25ScheduleItemTableViewCell")
